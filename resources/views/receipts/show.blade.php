            ...
            <div class="report-container">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-card">
                        ...
                        <span class="info-content">{{ $receipt->receipt_type == 'cash' ? 'نقدي' : 'بنكي' }}</span>
                    </div>

                    <div class="info-card">
                        <span class="info-title">الحساب</span>
                        <span class="info-content">
                            {{ $receipt->accountable?->name ?? '-' }}
                        </span>
                    </div>
                ...
                <div class="mt-6 flex gap-4">
                    <a href="{{ route('receipts.edit', $receipt->id) }}" class="btn btn-primary">تعديل السند</a>
                    <a href="{{ route('receipts.index') }}" class="btn btn-secondary">العودة للسندات</a>
                </div>
