<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">إضافة سند قبض</h2>
    </x-slot>
    ...
    <div class="py-12">
        ...
        <form class="smart-form" action="{{ route('receipts.store') }}" method="POST">
            @csrf
            ...
            <div class="row-2">
                ...
                <div class="form-group">
                    ...
                    <select name="receipt_type" required>
                        <option value="in" @selected(old('receipt_type') === 'deposit')>قبض</option>
                    </select>
                </div>
